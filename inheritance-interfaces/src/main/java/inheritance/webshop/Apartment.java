...
public class Apartment {
	...
	public Apartment(String address, int squareMeters, int numberOfRooms, boolean balcony, boolean elevator) {
		super();
	...
	public String toString() {
		return "Apartment [address=" + address + ", squareMeters=" + squareMeters + ", numberOfRooms=" + numberOfRooms
